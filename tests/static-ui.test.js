...
test('HTML and service worker reference the same release assets',()=>{for(const pattern of [/styles\.css\?v=50/,/app\.js\?v=50/,/v5-ui\.css\?v=51/,/v5-ui\.js\?v=51/,/audio-editor\.css\?v=52/,/audio-editor\.js\?v=52/]){assert.match(html,pattern);assert.match(sw,pattern)}assert.match(sw,/obsremote-v5-1-rc2/)});
