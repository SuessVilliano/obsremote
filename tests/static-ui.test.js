...
test('HTML and service worker reference the same release assets',()=>{for(const pattern of [/styles\.css\?v=50/,/app\.js\?v=50/,/v5-ui\.css\?v=51/,/v5-ui\.js\?v=51/]){assert.match(html,pattern);assert.match(sw,pattern)}assert.match(sw,/obsremote-v5-rc2/)});
